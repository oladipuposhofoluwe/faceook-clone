...
<div class="container">
    <div class="row">
        <div class="col-lg-7">
            <h1 class="logo mt-4">facebook</h1>
            ...
            <div class="shadow p-3 mb-5 bg-white rounded text-center form-bg">
                <form action="">
                    <div class="text-center">
                        <input class="email_input mt-3" type="email" for="email" id="email" placeholder="Email address or phone number" >
                        <input  class="password_input" type="password" for="password" placeholder="Password">
                        <button class="btn btn-primary btn-lg btn-block logging">Log In</button>
                        <p class="para">Forgotten password?</p>
                        <button type="submit" class="btn btn-success" data-toggle="modal" data-target="#signupmodal"> <a href="#">Create New Account</a></button>
                    </div>
                </form>
            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                ...
                <form>
                    <div class="row">
                        <div class="form-group col-md-6">
                            <input type="text" class="form-control input1" id="input" placeholder="First name">
                        </div>
                        <div class="form-group col-md-6">
                            <input type="text" class="form-control" id="input" placeholder="Surname">
                        </div>
                    </div>

                    <div class="form-group">
                        <input type="text" class="form-control" id="input" placeholder="Mobile number or email address">
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" id="input" placeholder="New Password">
                    </div>
                    ...
                    <div class="row gender">
                        <div class="form-group col-md-4">
                            ...
                            <div>
                                <select aria-label="Day" name="birthday_day" id="day" title="Day" class="_9407 _5dba _9hk6 _8esg _9m5o  date">
                        ...
                        <div class="form-group col-md-4">
                            <div>
                                <select aria-label="Month" name="birthday_month" id="month" title="Month" class="_9407 _5dba _9hk6 _8esg _9m5o date date1">
                        ...
                        <div class="form-group col-md-4">
                            <div>
                                <select aria-label="Year" name="birthday_year" id="year" title="Year" class="_9407 _5dba _9hk6 _8esg _9m5o date date1">
                        ...
                        <div class="form-group col-md-4">
                            <label for="inputCity"><small>Gender</small><i class="fas fa-question-circle"></i></label>                                    <div >
                                <span class="_5k_2 _5dba gender_female">
                                    ...
                                    <input type="radio" class="_8esa " name="sex" value="2" id="u_28_3_Fz">
                                </span>
                        </div>
                        </div>
                        ...
                        <div class="form-group col-md-4">
                            <div class="gender_male">
                                <span class="_5k_2 _5dba">
                                    ...
                                    <input type="radio" class="_8esa  gender_male2 " name="sex" value="2" id="u_28_3_Fz">
                                </span>
                            </div>
                        </div>
            ...
            <div class="modal-footer but">
                <button type="button" class="btn btn-success text">Save changes</button>
            </div>
        </div>
    </div>
</div>
